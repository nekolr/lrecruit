...
<style type="text/css">
.findPwd i.l-icon{ display: inline-block; background: url(images/Error_48.png) no-repeat; vertical-align: middle; margin-top: 0px;;cursor: pointer;}
...
<div class="findPwd">
    ...
    <div class="ct-pwd">
        <div class="logo-pwd">
            <h2 class="til-pwd til-success">您的简历还不完善哦</h2>
        </div>
        <!-- 重置密码成功 -->
