	...
	<div class="main">
		<div class="content">
			<div class="left">
				...
				<div class="gradeBshort on" data-url="entpuser/gomianshi">已安排面试</div>
							...
							<div class="opt_box">
								<div class="rt_opt">
								    <p>
										...
										<span data-opt="5" class="on" data-recordid="${item.recordid}">已录取</span>
							    ...
							    <div class="lf_opt">
									<p>
										...
										<span data-opt="1" class="on contactU" data-recordid="${item.recordid}">不合适</span>
