	...
	<div class="main">
		<div class="bg-jobPost">
			<div class="w1024 basic">
				<!-- form start -->
				<form action="entp/createEntp" method="post" id="form1" autocomplete="off" enctype="multipart/form-data">
					<!-- 公司基本信息 -->
					<div class="infor-basic">
						...
						<div class="con-basic">
							...
							<div class="row-pos">
								...
								<input name="entpname" type="text" placeholder="填写大家最熟悉的名字哦！填写之后不可修改哦！" class="txt noT" id="brand" />													
							</div>
							...
							<div class="row-pos">
								...
								<div id="industry" class="selc-child">
									<span><input type="text" placeholder="选择公司行业"
							...
							<div class="row-pos">
								...
								<div id="SizeCom" class="selc-child" data-val="">
									<span><input type="text" class="txt noBor"
