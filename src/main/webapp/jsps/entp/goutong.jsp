	...
	<div class="main">
		<div class="content">
			<div class="left">
				...
				<div class="gradeBshort on" data-url="entpuser/gogoutong">待沟通<div class="cvNum contacting"></div></div>
			...
			<div class="right">
			<form action="entpuser/gogoutong" id="fm_cv">
					...
					<div class="cv" data-cvid="${item.cvid}" data-jobid="${item.jobid}" data-url="gocv">
						...
						<div class="box_cv">
							<div class="opt_box">
								<div class="rt_opt">
								    <p>
										<span data-opt="4" class="on" data-recordid="${item.recordid}">已面试</span>
							    ...
							    <div class="lf_opt">
									<p>
										...
										<!-- <span data-opt="1" class="contactU">感兴趣</span> -->
										<span data-opt="2" class="on" data-recordid="${item.recordid}">发送面试邀请</span>
									</p>
								</div>
							</div>
				...
				laypage({
				  ...
				  jump: function(e, first){ //触发分页后的回调
				    if(!first){ //一定要加此判断，否则初始时会无限刷新
				      ...
				      location.href = "entpuser/gogoutong?"+fm;
				    }
				  }
				});
			</script>
