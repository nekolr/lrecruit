...
<script type="text/javascript" src="js/findpwd_entp.js"></script>
    ...
    <div class="findPwd">
        ...
        <div class="ct-pwd">
            ...
            <div class="oneStep-pwd mt30">
                ...
                <form action="entpuser/checkEmail" method="post" id="form1">
	                <div class="box-oneStep mt35">
	                    <div class="m6px box-user">
	                        <input id="username" class="txt user" name="entpemail" placeholder="请输入邮箱" type="text"/>
	                    </div>
	                    ...
	                    <div id="img-mo" class="m6px img-mo on">
	                        ...
	                        <div class="img_btn">
	                            <img id="comPicValidateCode" class="codeImg" src='<c:url value="entpuser/verifycode"></c:url>'/>
	                        </div>
	                    </div>
